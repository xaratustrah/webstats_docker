...
DOCKERHOST_USER = os.environ.get('DOCKERHOST_USER', '')

CMD_PREFIX = 'ssh -o LogLevel=QUIET -o StrictHostKeyChecking=no -tt -l {} {} '.format(
    DOCKERHOST_USER, DOCKERHOST)
CMD = [
    CMD_PREFIX + 'uname -n',
...
<html>
  <head>
    ...
    <a href="https://github.com/xaratustrah/webstats_docker" target="_blank"><img style="position: absolute; top: 0; right: 0; border: 0;"
